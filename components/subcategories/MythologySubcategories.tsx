...
import { mythologySubcats as subcats, mythologyTags as tags } from '../../util/constants';
...
const MythologySubcategories: React.FC<Props> = ({ dispatch, subcategories }) => {
	const [expanded, setExpanded] = useState<boolean>(false);
	
	return (
		<div>
			<h5>Mythology {expanded ? <ChevronUp height = "16" width = "16" onClick = {() => setExpanded(false)} /> :
...
export default MythologySubcategories;