...
import { fineArtsSubcats as subcats, fineArtsTags as tags } from '../../util/constants';
...
const FineArtsSubcategories: React.FC<Props> = ({ dispatch, subcategories }) => {
	const [expanded, setExpanded] = useState<boolean>(false);
	
	return (
		<div>
			<h5>Fine Arts {expanded ? <ChevronUp height = "16" width = "16" onClick = {() => setExpanded(false)} /> :
...
export default FineArtsSubcategories;