...
import { historySubcats as subcats, historyTags as tags } from '../../util/constants';
...
const HistorySubcategories: React.FC<Props> = ({ dispatch, subcategories }) => {
	const [expanded, setExpanded] = useState<boolean>(false);

	return (
		<div>
			<h5>History {expanded ? <ChevronUp height = "16" width = "16" onClick = {() => setExpanded(false)} /> :
