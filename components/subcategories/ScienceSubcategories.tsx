...
import { scienceSubcats as subcats, scienceTags as tags } from '../../util/constants';
...
const ScienceSubcategories: React.FC<Props> = ({ dispatch, subcategories }) => {
	const [expanded, setExpanded] = useState<boolean>(false);

	return (
		<div>
			<h5>Science {expanded ? <ChevronUp height = "16" width = "16" onClick = {() => setExpanded(false)} /> :
