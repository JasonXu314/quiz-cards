...
import { religionSubcats as subcats, religionTags as tags } from '../../util/constants';
...
const ReligionSubcategories: React.FC<Props> = ({ dispatch, subcategories }) => {
	const [expanded, setExpanded] = useState<boolean>(false);

	return (
		<div>
			<h5>Religion {expanded ? <ChevronUp height = "16" width = "16" onClick = {() => setExpanded(false)} /> :
...
export default ReligionSubcategories;