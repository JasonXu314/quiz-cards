...
import { trashSubcats as subcats, trashTags as tags } from '../../util/constants';
...
const TrashSubcategories: React.FC<Props> = ({ dispatch, subcategories }) => {
	const [expanded, setExpanded] = useState<boolean>(false);

	return (
		<div>
			<h5>Trash {expanded ? <ChevronUp height = "16" width = "16" onClick = {() => setExpanded(false)} /> :
