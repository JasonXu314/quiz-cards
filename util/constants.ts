...
export const geographySubcats = [
	'Geography American',
	'Geography World'
] as const, geographyTags = [
	'geo-am',
	'geo-wo'
] as const;

export const philosophySubcats = [
	'Philosophy American',
	'Philosophy Classical',
	'Philosophy East Asian',
	'Philosophy European',
	'Philosophy Other'
] as const, philosophyTags = [
	'phi-am',
	'phi-cl',
	'phi-ea',
	'phi-eu',
...
export const currentEventsSubcats = [
	'Current Events American',
	'Current Events Other'
] as const, currentEventsTags = [
	'cre-am',
	'cre-ot'
] as const;
